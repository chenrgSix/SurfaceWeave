...
/** Explicit host-configurable guardrails for untrusted Surface payloads. */
...
/** @deprecated Use SurfaceResourcePolicy. */
export type SurfaceResourceLimits = SurfaceResourcePolicy;

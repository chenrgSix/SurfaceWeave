...
| `@surfaceweave/react`       | React binding + optional DOM driver | React `>=18.2 <20`; optional React DOM for `./dom`        | Root without React DOM; `./dom` with React 19.2/DOM and Vite 8         |

...
| --------------------------- | ----------------------------- | --------------------------------------------------------- | ---------------------------------------------------------------------- |
| `protocol`                  | JSON/docs only                | None                                                      | Node JSON import; language-neutral Schema                              |
| `core`                      | Framework-agnostic ESM        | None                                                      | Node 22, strict CSP, no DOM lib                                        |
| `storage`                   | Framework-agnostic ESM        | Browser only for `LocalStorageAdapter`                    | Node 22 and browser build                                              |
| `preferences`               | Framework-agnostic ESM        | Core and Storage                                          | Node 22                                                                |
| `generator`                 | Framework-agnostic ESM        | Core                                                      | Node 22                                                                |
| `agent-tools`               | Framework-agnostic ESM        | Core, Generator, Preferences, Storage                     | Node 22                                                                |
| `renderer-react`            | React binding                 | React `>=18.2 <20`                                        | React 19.2, Vite 8                                                     |
| `component-pack-react-aria` | Optional React Pack           | React/DOM `>=18.2 <20`, React Aria Components `>=1.20 <2` | React 19.2, RAC 1.20, Vite 8                                           |
| `component-pack-antd`       | Optional React Pack           | React/DOM `>=18.2 <20`, Ant Design `>=6.5.3 <7`           | React 19.2, AntD 6.5, Vite 8                                           |
| `tauri`                     | Optional Tauri 2 host adapter | Tauri API `^2.8`, Store plugin `^2.4`                     | Clean TypeScript/Vite consumer, Cargo check, macOS Tauri release build |

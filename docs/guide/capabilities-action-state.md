...
These unreleased `main` APIs let a trusted host describe what it can render,
project execution state into every view, and bound untrusted Surface work. They
do not add a transport or change Wire Protocol 1.0.
